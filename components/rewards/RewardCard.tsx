                            ...
                            isConfirmingRedeem ? (
                                <div className="flex items-center gap-1.5">
                                    <button
                                        ...
                                        className="px-3 py-2 rounded-md bg-success text-white text-sm font-medium hover:bg-success/80 transition-colors"
                                    >
                                        Confirmar
                                    </button>
                                    <button
                                        onClick={() => setIsConfirmingRedeem(false)}
                                        className="px-3 py-2 rounded-md bg-bg-main text-text-secondary text-sm font-medium hover:bg-bg-main/80 transition-colors border border-border-card"
                                    >
                                        Cancelar
                                    </button>
                                </div>
